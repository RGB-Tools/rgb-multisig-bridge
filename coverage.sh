...
IGNORE_PATTERN="/rgb\-multisig\-bridge(/.*)?/(tests|examples|benches|migration/src/main.rs|src/database/entities|src/test)($|/)|/rgb\-multisig\-bridge/target/llvm\-cov\-target($|/)|^$HOME/\.cargo/(registry|git)/|^$HOME/\.rustup/toolchains($|/)"
